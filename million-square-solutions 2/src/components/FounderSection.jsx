    ...
    <section id="founder" className="relative py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: '🎯', title: 'Proven playbooks, not guesswork', text: 'Every onboarding flow, QBR framework, and churn response process has been tested and refined on real SaaS portfolios — not built in a boardroom.' },
            { icon: '🤖', title: 'AI-native from day one', text: 'I led GenAI integration into CS operations before most companies started the conversation. Your CSMs come equipped with tools that cut overhead and sharpen focus.' },
