    ...
    <section id="contact" className="py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-block px-4 py-2 rounded-full border border-primary/30 bg-primary/10 text-primary text-sm font-mono tracking-widest uppercase mb-4">Get Started Today</div>
          <h2 className="text-4xl md:text-5xl font-bold futuristic-heading mb-6">Scale Your Customer Success</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Ready to outsource your customer success operations? Let us discuss how our dedicated CSM teams can reduce churn and drive predictable NRR for your SaaS business — whether you are based in the US, UK, Canada, UAE, Australia, or New Zealand.</p>
        </div>
              ...
              <form name="contact" onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" id="name" name="name" value={formData.name} onChange={handleInputChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all" placeholder="John Doe" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-white mb-2">Work Email *</label>
                    <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all" placeholder="john@saas-company.com" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-white mb-2">Phone Number</label>
                    <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all" placeholder="+1 / +44 / +91 — Your Number" />
                  </div>
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-white mb-2">Focus Area *</label>
                    <select id="subject" name="subject" value={formData.subject} onChange={handleInputChange} required className="w-full px-4 py-3 bg-[#1a1a2e] border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all appearance-none">
                      ...
                      <option value="CS Strategy and Consulting">CS Strategy and Consulting</option>
                ...
                <div>
                  ...
                  <textarea id="message" name="message" value={formData.message} onChange={handleInputChange} required rows={4} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-primary focus:outline-none transition-all resize-none" placeholder="Tell us about your SaaS product, current CS challenges, team size, and what you are looking to achieve..." />
                </div>
          ...
          <div className="space-y-5">
            <div className="glass-morphism p-6 rounded-xl neon-glow border border-white/10 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 hover:-translate-y-1 flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@millionsquaresolutions.com" className="text-primary hover:text-white transition-colors">info@millionsquaresolutions.com</a>
            ...
            <div className="glass-morphism p-6 rounded-xl neon-glow border border-white/10 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/20 transition-all duration-300 hover:-translate-y-1 flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+919811813137" className="text-accent hover:text-white transition-colors">+91-9811813137</a>
                <p className="text-muted-foreground text-xs mt-1">India HQ — serving US, UK, Canada, UAE, Australia and NZ</p>
              </div>
            </div>
            <div className="glass-morphism p-6 rounded-xl neon-glow border border-white/10 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-primary italic mt-2">Our dedicated CSM teams align with your time zones — EST, PST, GMT, GST, AEST.</p>
              </div>
            </div>
          </div>
        </div>
